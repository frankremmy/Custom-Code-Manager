 ...
 * @subpackage Custom_Code_Manager/public
 */
 ...
 */
class Custom_Code_Manager_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $custom_code_manager       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/custom-code-manager-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/custom-code-manager-public.js', array( 'jquery' ), $this->version, false );
